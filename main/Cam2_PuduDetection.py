...
class CheckpointTracker:
    ...
    def process_frame(self, frame, conf_threshold=0.8):
    ...
    while running:
        try:
            try:
                ...
                cv2.imshow("Cam 2 - 10.109.61.158", processed_frame)
...
CHECKPOINT_AREAS = {
    'Station 3': (int(1131 * (640/1920)), int(377 * (480/1080)), int(1241 * (640/1920)), int(533 * (480/1080))),
    'Station 7': (int(1287 * (640/1920)), int(547 * (480/1080)), int(1506 * (640/1920)), int(796 * (480/1080)))
}
...
def main():
    ...
    try:
        ...
        if use_rtsp:
            ...
            url = "C:/Users/YMPI/Downloads/2025-04-16/10.109.61.158_01_20250416102333844.mp4"
