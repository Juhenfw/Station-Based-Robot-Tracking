...
if __name__ == "__main__":
    ...
    script_paths = [
        'D:/project/magang2025/Pudu_Monitoring_Station/Cam1_PuduDetection.py',
        'D:/project/magang2025/Pudu_Monitoring_Station/Cam2_PuduDetection.py',
        'D:/project/magang2025/Pudu_Monitoring_Station/Cam3_PuduDetection.py'
    ]
