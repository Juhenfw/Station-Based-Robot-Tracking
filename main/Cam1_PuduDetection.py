    ...
    while running:
        try:
            try:
                ...
                cv2.imshow("Cam 1 - 10.109.61.157", processed_frame)
...
CHECKPOINT_AREAS = {
    'Station 0': (int(924 * (640/1920)), int(165 * (480/1080)), int(955 * (640/1920)), int(247 * (480/1080))),
    'Station 1': (int(943 * (640/1920)), int(207 * (480/1080)), int(1029 * (640/1920)), int(357 * (480/1080))),
    'Station 9': (int(848 * (640/1920)), int(239 * (480/1080)), int(932 * (640/1920)), int(404 * (480/1080))),
    'Station 2': (int(713 * (640/1920)), int(738 * (480/1080)), int(907 * (640/1920)), int(1050 * (480/1080))),
    'Station 8': (int(430 * (640/1920)), int(830 * (480/1080)), int(670 * (640/1920)), int(1080 * (480/1080)))
}
...
def main():
    ...
    try:
        ...
        if use_rtsp:
            ...
            url = "D:/DATA-SHARED/video/2025-08-04/10.109.61.157_01_20250804120329388.mp4"
