...
CHECKPOINT_AREAS = {
    ...
    'Station 4': (int(1108 * (640/1920)), int(323 * (480/1080)), int(1198 * (640/1920)), int(457 * (480/1080))),
...
def main():
    ...
    try:
        ...
        model_path = 'D:/DATA/FOR_DL/objectdetection/magang2025/Pudu_Monitoring_Station/PuduSenban_trained.engine'
